      ...
      <header className="border-b border-white/5 bg-black/40 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
          ...
          <div className="text-right">
             <div className="text-[10px] font-black text-[#00E676] uppercase tracking-[0.5em] mb-1">CRM PRIVADO</div>
             <h1 className="text-2xl font-black italic tracking-tighter uppercase">Directorio de Clientes</h1>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        ...
        >
          ...
          <p className="text-[10px] font-medium text-gray-400 uppercase tracking-widest leading-relaxed mb-8">
            El gestor de relaciones con clientes (CRM) con importación masiva y análisis de riesgo crediticio se activará en la próxima actualización.
          </p>
          <Link href="/dashboard/company" className="inline-block border border-white/10 bg-white/5 px-8 py-3 text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-colors">
            Volver al Dashboard
          </Link>
        </motion.div>
      </main>
